 ...
 */
angular.module('ticketSystem',['ngRoute','textAngular','yangular-grid','yg-modal','ngFlash','ui.router','yg-notification'])
    .service('authInterceptor', ['$q','$injector','Authentication',
