...
angular.module("ticketSystem").factory("QueueFactory",["$http",function(e){var u={};return u.getQueues=function(){return e.get("admin/users/queue")},u.addQueue=function(u){return e.post("admin/users/queue",{name:u})},u.updateQueue=function(u,t){return e.put("admin/users/queue/"+u,{name:t})},u}]);
...
angular.module("ticketSystem").controller("QueueManagementCtrl",["$scope","PaginationService","QueueFactory","YgNotify",function(e,u,a,t){function d(){e.setPage(1)}function n(a){a<1||a>e.pager.totalPages||(e.pager=u.GetPager(e.queues.length,a),e.items=e.queues.slice(e.pager.startIndex,e.pager.endIndex+1))}e.queues=[],a.getQueues().then(function(u){e.queues=u.data.queues,d()}).catch(function(e){t.alert("danger","There was some error trying to get the queue details. Please try again after some time.",5e3)}),e.pager={},e.setPage=n,e.showAddQueuePanel=function(){e.showAddQueue=!0},e.hideAddQueuePanel=function(){e.showAddQueue=!1,e.addQueueForm.newQueue.$touched=!1,e.newQueue=""},e.showUpdateQueuePanel=function(u){console.log(u),e.showUpdateQueue=!0,e.updateQueueId=u,e.updateQueueName=e.queues.find(function(e){return e._id===u}).name},e.hideUpdateQueuePanel=function(){e.showUpdateQueue=!1,e.updateQueueForm.updateQueue.$touched=!1,e.updateQueueId="",e.updateQueueName=""},e.addQueue=function(){return e.addQueueForm.$invalid?void(e.addQueueForm.newQueue.$touched=!0):void a.addQueue(e.newQueue).then(function(u){e.queues=u.data.queues,e.setPage(e.pager.currentPage),e.newQueue="",addQueueForm.newQueue.$touched=!1,e.showAddQueue=!1,t.alert("success","Queue has been added successfully",5e3)}).catch(function(e){t.alert("danger","There was some error trying to add a new queue. Please try again after some time.",5e3)})},e.updateQueue=function(){return e.updateQueueForm.$invalid?void(e.updateQueueForm.updateQueueName.$touched=!0):void a.updateQueue(e.updateQueueId,e.updateQueueName).then(function(u){e.queues=u.data.queues,e.setPage(e.pager.currentPage),e.updateQueueName="",e.updateQueueId="",updateQueueForm.updateQueueName.$touched=!1,e.showUpdateQueue=!1,t.alert("success","Queue name has been updated successfully",5e3)}).catch(function(e){t.alert("danger","There was some error trying to update the queue name. Please try again after some time.",5e3)})}}]);
