...
angular.module("ticketSystem").factory("QueueFactory",["$http",function(e){var u={};return u.getQueues=function(){return e.get("admin/users/get-queues")},u.addQueue=function(u){return e.post("admin/users/add-queue",{name:u})},u}]);
...
angular.module("ticketSystem").controller("QueueManagementCtrl",["$scope","PaginationService","QueueFactory","YgNotify",function(e,u,t,a){function n(){e.setPage(1)}function d(t){t<1||t>e.pager.totalPages||(e.pager=u.GetPager(e.queues.length,t),e.items=e.queues.slice(e.pager.startIndex,e.pager.endIndex+1))}e.queues=[],t.getQueues().then(function(u){e.queues=u.data.queues,n()}).catch(function(e){a.alert("danger","There was some error trying to get the queue details. Please try again after some time.",5e3)}),e.pager={},e.setPage=d,e.showAddQueuePanel=function(){e.showAddQueue=!0},e.hideAddQueuePanel=function(){e.showAddQueue=!1,e.addQueueForm.newQueue.$touched=!1,e.newQueue=""},e.addQueue=function(){return e.addQueueForm.$invalid?void(e.addQueueForm.newQueue.$touched=!0):void t.addQueue(e.newQueue).then(function(u){e.queues=u.data.queues,e.setPage(e.pager.currentPage),e.newQueue="",addQueueForm.newQueue.$touched=!1,e.showAddQueue=!1,a.alert("success","Queue has been added successfully",5e3)}).catch(function(e){a.alert("danger","There was some error trying to add a new queue. Please try again after some time.",5e3)})}}]);
