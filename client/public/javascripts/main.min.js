...
angular.module("ticketSystem").controller("DashboardCtrl",["$scope","$state","YgNotify","TicketFactory",function(e,n,t,o){var a=function(e){return new Date(Date.parse(e)).toLocaleDateString()},s=function(e){return e?String(e).replace(/<[^>]+>/gm,""):""},r=function(e){return e?e:"Unassigned"};e.config={},e.config.columns=[],e.config.columns.push({key:"id",name:"ID",cssClass:"col-md-1"}),e.config.columns.push({key:"title",name:"Title",cssClass:"col-md-2"}),e.config.columns.push({key:"description",name:"Description",cssClass:"col-md-2",render:s}),e.config.columns.push({key:"type",name:"Type",cssClass:"col-md-1"}),e.config.columns.push({key:"assignee",name:"Assignee",cssClass:"col-md-2",render:r}),e.config.columns.push({key:"createdDate",name:"Created Date",cssClass:"col-md-2",render:a}),e.config.columns.push({key:"createdBy",name:"Created By",cssClass:"col-md-2"}),e.config.url="/admin/open-within-day",e.config.sortQuerystringParam="sort",e.config.orderQuerystringParam="order",e.config.pageQuerystringParam="page",e.config.sizeQuerystringParam="size",e.config.onRowClick=function(e){n.go("ticket-view",{id:e.id})},e.config.objectName="tickets",o.getDashboardData().then(function(e){var n=e.data.tickets;new Chart(document.getElementById("statusChart"),{type:"pie",data:{labels:["New","Open","In-Progress","Awaiting Response"],datasets:[{data:[n.new.count,n.open.count,n.inProgress.count,n.awaitingUserResponse.count],backgroundColor:["#039BE5","#F44336","#FFB300","#43A047"],hoverBackgroundColor:["#039BE5","#F44336","#FFB300","#43A047"]}]},options:{legend:{labels:{boxWidth:12,fontSize:10}}}}),new Chart(document.getElementById("typeChart"),{type:"pie",data:{labels:["Bug","Need Info","Improvement"],datasets:[{data:[n.bug.count,n.needInfo.count,n.improvement.count],backgroundColor:["#F44336","#039BE5","#FFB300"],hoverBackgroundColor:["#F44336","#039BE5","#FFB300"]}]},options:{legend:{labels:{boxWidth:12,fontSize:10}}}}),new Chart(document.getElementById("priorityChart"),{type:"pie",data:{labels:["High","Medium","Low"],datasets:[{data:[n.high.count,n.medium.count,n.low.count],backgroundColor:["#F44336","#FFB300","#43A047"],hoverBackgroundColor:["#F44336","#FFB300","#43A047"]}]},options:{legend:{labels:{boxWidth:12,fontSize:10}}}})}).catch(function(e){t.alert("danger","An error occurred while trying to fetch the dashboard data. Please try again later.",5e3)})}]);
