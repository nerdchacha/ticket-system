...
angular.module("ticketSystem").factory("QueueFactory",["$http",function(e){var u={};return u.getQueues=function(){return e.get("admin/users/queue")},u.addQueue=function(u){return e.post("admin/users/queue",{name:u})},u}]);
