...
angular.module("ticketSystem").controller("ActionsCtrl",["$scope","ActionFactory","HelperFactory",function(e,t,a){e.getTask=t.getTask,e.task={},e.setSaveFn=function(t){e.saveTask=t},e.cancelTask=function(){t.setTask(null),e.task.comment="",e.task.showTaskPanel=!1,e.task.showMainPanel=!1},e.setSaveBtnName=function(t){e.saveBtnName=t},e.$watch("getTask()",function(t,a){if(t)switch(e.task.showTaskPanel=!0,e.task.showMainPanel=!0,e.task.name="templates/partials/action/"+t+"-action-partial.html",t){case"comment":e.task.title="Add new comment";break;case"awaitingusersresponse":e.task.title="Awaiting users response";break;case"close":e.task.title="Close ticket";break;case"reopen":e.task.title="Reopen ticket";break;case"acknowledge":e.task.title="Acknowledge ticket";break;case"assign":e.task.title="Assign ticket";break;case"changestatus":e.task.title="Change ticket status"}})}]).controller("AssignActionCtrl",["$scope","ActionFactory","YgNotify","HelperFactory",function(e,t,a,s){t.getAssignees().then(function(t){e.users=t.data.users,e.users=s.removeUserFromUsers(e.users,[e.ticket.createdBy,e.ticket.assignee]),e.assignee=e.users[0].username}),e.setSaveFn(function(){t.assign(e.ticket.id,e.assignee,e.task.comment).then(function(t){if(t.data.errors){var n=s.createErrorMessage(t.data.errors);return void n.forEach(function(e){a.alert("danger",e,5e3)})}e.ticket.comments=t.data.comments,e.ticket.assignee=t.data.assignee,a.alert("success","The assignee has been changed successfully",5e3),e.cancelTask()}).catch(function(t){a.alert("danger","There was some error trying to assign the ticket. Please try again after some time.",5e3),e.cancelTask()})}),e.setSaveBtnName("Assign Ticket")}]).controller("ChangeStatusActionCtrl",["$scope","ActionFactory","YgNotify",function(e,t,a){var s=e.ticket.status;t.getAllowedStatus(s).then(function(t){e.allowedStatus=t.data.status.allowed,e.newStatus=e.allowedStatus[0]}),e.setSaveFn(function(){t.changeStatus(e.ticket.id,e.newStatus,e.task.comment).then(function(t){e.ticket.comments=t.data.comments,e.ticket.status=t.data.status,a.alert("success","The assignee has been changed successfully",5e3),e.cancelTask()}).catch(function(t){a.alert("danger","There was some error trying to change the ticket status. Please try again after some time.",5e3),e.cancelTask()})}),e.setSaveBtnName("Change Status")}]).controller("CommentActionCtrl",["$scope","ActionFactory","YgNotify",function(e,t,a){e.setSaveFn(function(){t.addComment(e.ticket.id,e.task.comment).then(function(t){e.ticket.comments=t.data.comments,a.alert("success","The comment has been added successfully",5e3),e.cancelTask()}).catch(function(t){a.alert("danger","There was some error trying to add comment. Please try again after some time.",5e3),e.cancelTask()})}),e.setSaveBtnName("Add Comment")}]).controller("CloseActionCtrl",["$scope","ActionFactory","YgNotify",function(e,t,a){e.setSaveFn(function(){t.close(e.ticket.id,e.task.comment).then(function(t){e.ticket.comments=t.data.comments,e.ticket.status=t.data.status,a.alert("success","The status has been changed successfully",5e3),e.cancelTask()}).catch(function(t){a.alert("danger","There was some error trying to change the ticket status. Please try again after some time.",5e3),e.cancelTask()})}),e.setSaveBtnName("Close")}]).controller("ReopenActionCtrl",["$scope","ActionFactory","YgNotify",function(e,t,a){e.setSaveFn(function(){t.reopen(e.ticket.id,e.task.comment).then(function(t){e.ticket.comments=t.data.comments,e.ticket.status=t.data.status,a.alert("success","The status has been changed successfully",5e3),e.cancelTask()}).catch(function(t){a.alert("danger","There was some error trying to change the ticket status. Please try again after some time.",5e3),e.cancelTask()})}),e.setSaveBtnName("Reopen")}]).controller("AwaitingActionCtrl",["$scope","ActionFactory","YgNotify",function(e,t,a){e.setSaveFn(function(){t.awaitingUserResponse(e.ticket.id,e.task.comment).then(function(t){e.ticket.comments=t.data.comments,e.ticket.status=t.data.status,a.alert("success","The status has been changed successfully",5e3),e.cancelTask()}).catch(function(t){a.alert("danger","There was some error trying to change the ticket status. Please try again after some time.",5e3),e.cancelTask()})}),e.setSaveBtnName("Change Status")}]);
