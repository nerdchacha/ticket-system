...
angular.module('ticketSystem')
    .controller('ViewTicketCtrl',function($scope, $stateParams, $state, TicketFactory, Flash, Authentication){
        $scope.ticket = {};
    ...
    .controller('CommentCtrl',function($scope, $window, YgModal, TicketFactory, Flash){
